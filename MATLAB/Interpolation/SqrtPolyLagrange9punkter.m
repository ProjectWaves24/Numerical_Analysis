...
plot(t,  y,'o b',  'LineWidth',2)


  xlabel('x')
  ylabel('funktion f(x)')
legend('exact f(x)=sqrt(x)','interp.punkter','mätdata');
...
hold on
 ...
 xlabel('x')
  ylabel('fel: |LagrangePolyn - sqrt(x)|; ')
...
hold on
 ...
 xlabel('x')
  ylabel('fel: log10|LagrangePolyn - sqrt(x)|; ')
...
figure
 ...
 xlabel('x')
  ylabel('fel: |LagrangePolyn - sqrt(x)|; ')
  legend('Fel med ekvidistanta punkter');
...
figure
 ...
 xlabel('x')
  ylabel('fel: log10|LagrangePolyn - sqrt(x)|; ')
  legend('Log10-fel med ekvidistanta punkter');
