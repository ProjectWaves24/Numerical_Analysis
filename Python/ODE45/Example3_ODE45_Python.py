...
from func_example3_Python import func_example3
...
sol=isc.solve_ivp(func_example3,[t0,ts],y0,'RK45',t)
...
#sol=isc.solve_ivp(func_example3,[-1,5],[1],'RK45',tode45,rtol=1e-4,atol=[1e-4]))
