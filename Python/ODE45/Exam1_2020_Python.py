...
from funcsystem_ode45exam12020_Python import funcsystem_ode45exam12020
from func1_sysexam12020_Python import func1_sysexam12020
from func2_sysexam12020_Python import func2_sysexam12020
...
sol=isc.solve_ivp(funcsystem_ode45exam12020,[t0,ts],y0,'RK45',t)
...
for k in range(0,N-1):
    y1[k+1]=y1[k]+h*func1_sysexam12020(t[k],y1[k],y2[k])
    y2[k+1]=y2[k]+h*func2_sysexam12020(t[k],y1[k],y2[k])
    #t[k+1]=t[k]+h
